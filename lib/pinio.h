...
#define MEGA_PIN_D6_DIGITAL \
    (DigitalPin) { .pDDR = &DDRH, .pPIN = &PINH, .pPORT = &PORTH, .pin = PH3 }
#define MEGA_PIN_D7_DIGITAL \
    (DigitalPin) { .pDDR = &DDRH, .pPIN = &PINH, .pPORT = &PORTH, .pin = PH4 }
#define MEGA_PIN_D8_DIGITAL \
    (DigitalPin) { .pDDR = &DDRH, .pPIN = &PINH, .pPORT = &PORTH, .pin = PH5 }
#define MEGA_PIN_D9_DIGITAL \
    (DigitalPin) { .pDDR = &DDRH, .pPIN = &PINH, .pPORT = &PORTH, .pin = PH6 }
...
#define MEGA_PIN_D16_DIGITAL \
    (DigitalPin) { .pDDR = &DDRH, .pPIN = &PINH, .pPORT = &PORTH, .pin = PH1 }
...
#define MEGA_PIN_D42_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL7 }
#define MEGA_PIN_D43_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL6 }
#define MEGA_PIN_D44_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL5 }
#define MEGA_PIN_D45_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL4 }
#define MEGA_PIN_D46_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL3 }
#define MEGA_PIN_D47_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL2 }
#define MEGA_PIN_D48_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL1 }
#define MEGA_PIN_D49_DIGITAL \
    (DigitalPin) { .pDDR = &DDRL, .pPIN = &PINL, .pPORT = &PORTL, .pin = PL0 }
